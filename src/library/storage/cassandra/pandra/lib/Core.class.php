...
class PandraCore {
    ...
    static public function setReadMode($newMode) {
        if (!array_key_exists($newMode, self::$_supportedModes)) throw new RuntimeException("Unsupported Read Mode");
    ...
    static public function setWriteMode($newMode) {
        if (!array_key_exists($newMode, self::$_supportedModes)) throw new RuntimeException("Unsupported Write Mode");
